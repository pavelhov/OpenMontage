---
name: "source-command-ink-art"
description: "Migrated source command `ink-art`"
---

# source-command-ink-art

Use this skill when the user asks to run the migrated source command `ink-art`.
