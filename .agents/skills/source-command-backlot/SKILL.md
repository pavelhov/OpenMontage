---
name: "source-command-backlot"
description: "Migrated source command `backlot`"
---

# source-command-backlot

Use this skill when the user asks to run the migrated source command `backlot`.
