---
name: "source-command-animated-drawing"
description: "Migrated source command `animated-drawing`"
---

# source-command-animated-drawing

Use this skill when the user asks to run the migrated source command `animated-drawing`.
